...
def write_csv(input_csv_path: str, finalized_transactions: list[tuple[datetime, str, Decimal, str]]) -> None:
...
def get_finalized_transactions(csv_rows: list[list[str]]) -> list[tuple[datetime, str, Decimal, str]]:
...
def main() -> None:
    ...
    finalized_transactions: list[tuple[datetime, str,
